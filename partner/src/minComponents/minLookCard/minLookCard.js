...
import './minLookCard.css'
import MINModalProduct from './minModalProduct/minModalProduct';
...
const MINLookCard = ({currIndex, setCurrIndex,item}) => {
    ...
    async function getSeller () {
      const json = await getSellerInfo('s1');
      if(json.success) {
