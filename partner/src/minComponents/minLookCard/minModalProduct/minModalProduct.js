...
import './minModalProduct.css'

const MINModalProduct = ({item}) => {
    ...
    <div className="minMPBox" >
      ...
      <div onClick={()=>{}} className="minMPInfoBox">
        ...
        <div className="minMPInfoRB">
          <MINRatingBox stars={product===undefined? 0:product.ratingCount}></MINRatingBox>
...
export default MINModalProduct