   ...
   {loader1 ? <FullScreenLoader/> : null}
    ...
    <div className="draftitems">
        ...
        <div className='draftitemsModified'>{convertDate(item.updatedAt)}</div>
          <div ref={d1Ref} className='draftitemsMore' onClick={()=>{ setDrop1(!drop1)}}>
          <i className="fa-solid fa-ellipsis-vertical" >
          <div className={drop1?"draftdropdown-content":"draftdropdown-contentInactive"}>
          <div className="draftdcontent">
            <p onClick={openEditPage} className='draftcontentitem'>Edit</p>
            <p className='draftcontentitem' onClick={ openModal}>Delete</p>
            </div>
            </div>
          </i>
          </div>
